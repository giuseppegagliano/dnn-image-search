# DNN Image search engine
A search by image engine using DNN. 

## Make it work
* Add the opencv.jar and the opencv jar from [here](https://people.eecs.berkeley.edu/~rkn/temp/org/bytedeco/javacpp-presets/opencv/3.1.0-1.2-SNAPSHOT/) to the dependencies.
