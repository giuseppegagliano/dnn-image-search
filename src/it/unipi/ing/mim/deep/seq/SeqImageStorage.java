...
public class SeqImageStorage {
	...
	public SeqImageStorage(Parameters params) {
		super();
		this.params = params;
	}

	
	public List<ImgDescriptor> extractFeatures(File imgFolder){
		...
		for (int i = 0; i < files.length; i++) {
			...
			try {
				...
				float[] features = extractor.extract(files[i], params.DEEP_LAYER);
