...
public class ImgDescriptor implements Serializable, Comparable<ImgDescriptor> {
	...
	//Comparator class
		public static Comparator<ImgDescriptor> ImgDescriptorComparator = new Comparator<ImgDescriptor>() {

			public int compare(ImgDescriptor imgd1, ImgDescriptor imgd2) {

				//ascending order
				return imgd1.compareTo(imgd2);
			}
